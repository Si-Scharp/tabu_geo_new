...
GeoCard tk = GeoCard()
    ..image = (GeoImage()
        ..url = "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f8/World_map_with_equator.jpg/690px-World_map_with_equator.jpg")
    ..forbiddenWords = ["Halbkugel", "Breitenkreis", "teilt"]
    ..term = "Äquator"
    ..definition = "Größter Breitenkreis auf der Erde, der die Erdkugel in die nördliche und südliche Halbkugel teilt"
    ;